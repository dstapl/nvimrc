return {
	...
	opts = {
		...
		editor = {
			...
			client = "neovim",                          -- vim, neovim, lunarvim, nvchad, astronvim or your application"s client id tooltip = "The Superior Text Editor",       -- Text to display when hovering over the editor"s image
		},
		display = {
			-- theme = ?
